...
type postR struct {
	...
	Comments CommentSlice `csv:"Comments" boil:"Comments" json:"Comments" toml:"Comments" yaml:"Comments"`
}
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(postPrimaryKeyColumns) == 0 {
				return errors.New("model: unable to upsert posts, could not build conflict column list")
			}
