...
type userR struct {
	...
	Posts    PostSlice    `csv:"Posts" boil:"Posts" json:"Posts" toml:"Posts" yaml:"Posts"`
}
...
func (o *User) GetPosts() PostSlice {
	if o == nil {
		return nil
	}
...
func (userL) LoadComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadPosts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
