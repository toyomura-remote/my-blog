...
type PostUseCase interface {
	...
	UpdatePost(ctx context.Context, updatePostInput dto.CreatePostInput, userID int64) error
...
func (u *postUseCase) UpdatePost(ctx context.Context, updatePostInput dto.CreatePostInput, userID int64) error {
	return nil
}
